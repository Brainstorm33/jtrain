...
<div class="xoo-wsc-modal">
	...
	<?php if($show_basket != 'hide_always'): ?>
		<?php
			...
			$show_basket_style = $hide_basket === false  && $show_basket == 'hide_empty' && WC()->cart->is_empty()? 'display:none;' : '';

		?>
		<ul class="xoo-wsc-basket <?php if( $hide_basket ) echo 'xoo-wsc-basket-hidden'; ?>" style="<?php echo $show_basket_style; ?>">
			<?php if($show_count == 1): ?>
				<?php
			...
			?>
			<?php endif; ?>
            <li>Cart <span><?php echo $count_value ?></span></li>
		</ul>
	<?php endif; ?>
