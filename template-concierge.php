									...
									<div class="btn-row">
										<button class="h6 flex fjc fac">
											...
											<span class="icon"> <svg xmlns="http://www.w3.org/2000/svg"
											                         ...
											                         width="71px" height="71px" viewBox="0 0 100 100"
							...
							if ( $pf['facebook_url'] ):?>
								<a href="<?php echo $pf['facebook_url']; ?>" class="social-link" target="_blank">
									<svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 46 46"
										...
										<circle cx="23.0005" cy="23" r="23" fill="white"/>
										<path
											d="M27.5445 14.2594H29.8863V10.1806C29.4823 10.1251 28.0928 10 26.4746 10C23.0981 10 20.7851 12.1238 20.7851 16.0272V19.6196H17.0591V24.1793H20.7851V35.6523H25.3533V24.1804H28.9286L29.4962 19.6207H25.3523V16.4793C25.3533 15.1615 25.7082 14.2594 27.5445 14.2594Z"
											fill="#0057FF"/>
									</svg>
								</a>
							<?php endif;
							if ( $pf['linkedin_url'] ):?>
								<a href="<?php echo $pf['linkedin_url']; ?>" class="social-link" target="_blank">
									<svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 46 46"
										...
										<circle cx="23.0005" cy="23" r="23" fill="white"/>
										<path
											d="M36.9941 35.6521V35.651H37.0005V26.243C37.0005 21.6406 36.0097 18.0952 30.6291 18.0952C28.0425 18.0952 26.3067 19.5146 25.5981 20.8603H25.5232V18.5249H20.4216V35.651H25.7338V27.1708C25.7338 24.938 26.1571 22.7789 28.9222 22.7789C31.6467 22.7789 31.6873 25.327 31.6873 27.314V35.6521H36.9941Z"
											fill="#0057FF"/>
										<path d="M11.7715 18.5264H17.0901V35.6525H11.7715V18.5264Z" fill="#0057FF"/>
										<path
											d="M14.4286 10C12.728 10 11.3481 11.3799 11.3481 13.0804C11.3481 14.781 12.728 16.1897 14.4286 16.1897C16.1291 16.1897 17.509 14.781 17.509 13.0804C17.5079 11.3799 16.128 10 14.4286 10V10Z"
											fill="#0057FF"/>
									</svg>
								</a>
							<?php endif; ?>
