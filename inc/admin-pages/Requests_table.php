...
class Groups_List extends WP_List_Table {
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			...
			case 'phone':
				return '<a href="tel:'.stripslashes($item[ $column_name ]).'">'.stripslashes($item[ $column_name ]).'</a>';
			case 'email':
				return '<a href="mailto:'.stripslashes($item[ $column_name ]).'">'.stripslashes($item[ $column_name ]).'</a>';
			case 'submitted_from':
				return '<a href="'.get_page_link($item[ $column_name ]).'">'.get_the_title($item[ $column_name ]).'</a>';
			default:
